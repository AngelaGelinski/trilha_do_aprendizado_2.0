...
if (verificacao == true) {
    ...
    if ((homem_maior + homem_menor) != 0) {
        alert("O homem mais velho tem " + homem_velho + " anos e o mais novo tem " + homem_novo + ", Tem " + homem_maior + " homens maiores de idade")
    } else {
    ...
    if ((mulher_maior + mulher_menor) != 0) {
        alert("A mulher mais velha tem " + mulher_velha + " anos e a mais nova tem " + mulher_nova + ", Tem " + mulher_maior + " mulheres maiores de idade")
    } else {
